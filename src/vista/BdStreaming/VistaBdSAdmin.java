...
public class VistaBdSAdmin extends JFrame {
	...
	public VistaBdSAdmin() {
		...
		modeloTablaClases.setColumnIdentifiers(
				new Object[] { "ID", "Nombre Clase", "Actividad", "Fecha", "Limite Almacenamiento" });
	...
	private class BtnDefinirLimiteListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			// Obtener la actividad seleccionada del combo, necesitamos un listado de
			// actividades totales del gimnasio
