...
public class VistaCambiarEstado extends JFrame{
	...
	public void configurarTabla(ArrayList<Clase> clases) {
		for(Clase clase: controlador.getSede().getClases()) {
			Object[] rowData = { clase.getnombre(),clase.getEstado(),clase.getCapacidad(),clase.getInscriptos(),clase.getActividad(),clase.getFecha(),clase.getProfesor().getNombre(),clase.getCosto()};
