...
public enum TipoAmortizacion {
	DIAS_FABRICACION {
		...
		@Override
		public double calcularAmortizacion(int cantClasesUsadas, LocalDate fechaFabricacion, int diasUtiles,
				double precio) {
			// TODO
			return 0;
		}
	...
	CLASES_USADAS {
		...
		@Override
		public double calcularAmortizacion(int cantClasesUsadas, LocalDate fechaFabricacion, int clasesUtiles,
				double precio) {
			// TODO
			return 0;
		}
	...
	public abstract double calcularAmortizacion(int cantClasesUsadas, LocalDate fechaFabricacion, int durabilidad,
			double precio);
